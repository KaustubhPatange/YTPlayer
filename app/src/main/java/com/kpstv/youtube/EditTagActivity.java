...
public class EditTagActivity extends AppCompatActivity {
    ...
    @BindView(R.id.edit_ImageView) ImageView mainImage;
 //   @BindView(R.id.chooseImage) FloatingActionButton chooseImageButton;
    @BindView(R.id.TextView_title) EditText eTitle;
    @BindView(R.id.TextView_album) EditText eAlbum;
    @BindView(R.id.TextView_artist) EditText eArtist;
    @BindView(R.id.TextView_year) EditText eYear;
    @BindView(R.id.TextView_number) EditText eTrack;
    @BindView(R.id.TextView_album_artist) EditText eComposer;
    @BindView(R.id.TextView_location) EditText eComment;
    @BindView(R.id.TextView_genre) AutoCompleteTextView eGenre;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (model!=null) {
            ...
            if (title!=null) eTitle.setText(title); else eTitle.setText(model.getTitle());
